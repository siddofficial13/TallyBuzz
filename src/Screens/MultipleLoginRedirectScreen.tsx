  ...
  const handleLogin = async () => {
    try {
      ...
      if (token !== null) {
        ...
        await fetch(
          'https://surgeon-next-symantec-tops.trycloudflare.com/send-notification-authorised-login',
          {
            method: 'POST',
            headers: {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (token !== null) {
        // Send notification to the current device (device Z)
        await fetch(
          'https://surgeon-next-symantec-tops.trycloudflare.com/send-notification-unauthorised-login',
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
