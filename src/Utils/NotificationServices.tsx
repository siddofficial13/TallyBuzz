...
// export const handleBackgroundEvent = async ({type, detail}: any) => {
//   console.log('Background event:', type, 'Detail:', detail);
//   if (type === EventType.ACTION_PRESS && detail.pressAction?.id) {
//     console.log('Action Press Event');
...
//     } else if (type === EventType.PRESS) {
//       console.log(
//         'Enetered event.type === EventType.PRESS in notifee.onForegroundEvent',
//       );
//       handleNavigation(detail.notification?.data);
//     }
//   });
...
//     console.log('Enetered notifee.onBackgroundEvent');
//     await handleBackgroundEvent(event);
//     if (event.type === EventType.PRESS) {
//       console.log(
//         'Enetered event.type === EventType.PRESS in notifee.onBackgroundEvent',
//       );
